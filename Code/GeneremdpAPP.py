...
Label_subtitle = Label(frame, text="Veuillez choisir la longueur de votre mot de passe:", font=("Helvetica", 16), bg='#4065A4', fg='white')
...
longueur = Entry(frame, width=5, font=("Helvetica", 16), bg='#4065A4', fg='white')
longueur.grid(row=2, sticky=N)

mdpOutput = Entry(frame, width=30, font=("Helvetica", 16), bg='#4065A4', fg='white')
mdpOutput.grid(row=7, sticky=N, pady=20)

# Création des cases à cocher
c1 = Checkbutton(frame, text="Lettres", font=("Helvetica", 14), bg='#4065A4', fg='white')
c1.grid(row=4, sticky=N, pady=5)

c2 = Checkbutton(frame, text="Chiffres", font=("Helvetica", 14), bg='#4065A4', fg='white')
c2.grid(row=5, sticky=N, pady=5)

c3 = Checkbutton(frame, text="Caractère spéciaux", font=("Helvetica", 14), bg='#4065A4', fg='white')
...
print("Bienvenue dans le générateur de mot de passe 9000!")

print("Veuillez choisir la longueur de votre mot de passe:")

longueur = int(input())

use_lettre = input("Voulez vous des lettres? (y/n)").lower() == "y"

use_chiffre = input("Voulez vous des chiffres? (y/n)").lower() == "y"

use_carspe = input("Voulez vous des caractères spéciaux? (y/n)").lower() == "y"
